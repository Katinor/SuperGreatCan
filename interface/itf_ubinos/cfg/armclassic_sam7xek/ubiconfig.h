#ifndef UBICONFIG_H__itf_ubinos_
#define UBICONFIG_H__itf_ubinos_
...
#define UBI_CPU_TYPE							UBI_CPU_TYPE__ARM7TDMI
#define UBI_THUMB_MODE							0
#define UBI_THUMB_INTERWORK						1
...
#endif /* UBICONFIG_H__itf_ubinos_ */
