#ifndef UBICONFIG_H__lib_default
#define UBICONFIG_H__lib_default
...
#define UBI_COMPONENT__lib_default
#define UBI_COMCONFIG__lib_default

#endif /* UBICONFIG_H__lib_default */
