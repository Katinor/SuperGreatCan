...
CFLAG_SAM						+= -Dpart=SAM4E16E#lowpower
CFLAG_SAM						+= -std=c99
...
INCLUDE_MCU_CORE				+= -I$(ITFDIR)/../kernel/porting/lib_sam4e/common/services/serial #lowpower
INCLUDE_MCU_CORE				+= -I$(ITFDIR)/../kernel/porting/lib_sam4e/common/services/serial/sam_uart #lowpower
INCLUDE_MCU_CORE				+= -I$(ITFDIR)/../kernel/porting/lib_sam4e/common/utils/stdio #cms
INCLUDE_MCU_CORE				+= -I$(ITFDIR)/../kernel/porting/lib_sam4e/common/utils/stdio/stdio_serial #cms

INCLUDE_MCU_CORE				+= -I$(ITFDIR)/../kernel/porting/lib_sam4e/sam/utils/cmsis/sam4e/include/pio #lowpower

INCLUDE_MCU_CORE				+= -I$(ITFDIR)/../kernel/porting/lib_sam4e/sam/boards #lowpower
INCLUDE_MCU_CORE				+= -I$(ITFDIR)/../kernel/porting/lib_sam4e/sam/drivers/efc #lowpower
INCLUDE_MCU_CORE				+= -I$(ITFDIR)/../kernel/porting/lib_sam4e/sam/drivers/gpbr #lowpower
INCLUDE_MCU_CORE				+= -I$(ITFDIR)/../kernel/porting/lib_sam4e/sam/drivers/pio #lowpower
INCLUDE_MCU_CORE				+= -I$(ITFDIR)/../kernel/porting/lib_sam4e/sam/drivers/supc #lowpower
INCLUDE_MCU_CORE				+= -I$(ITFDIR)/../kernel/porting/lib_sam4e/sam/drivers/usart #lowpower
INCLUDE_MCU_CORE				+= -I$(ITFDIR)/../kernel/porting/lib_sam4e/sam/drivers/uart #lowpower
INCLUDE_MCU_CORE				+= -I$(ITFDIR)/../kernel/porting/lib_sam4e/sam/drivers/wdt #lowpower
INCLUDE_MCU_CORE				+= -I$(ITFDIR)/../kernel/porting/lib_sam4e/thirdparty/CMSIS/Lib/GCC #lowpower

INCLUDE_MCU_CORE				+= -I$(ITFDIR)/../kernel/porting/lib_sam4e/sam/applications/sam_low_power/sam4e16e_sam4e_ek #lowpower
INCLUDE_MCU_CORE				+= -I$(ITFDIR)/../kernel/porting/lib_sam4e/sam/applications/sam_low_power/sam4e16e_sam4e_ek/gcc #lowpower

INCLUDE_MCU_CORE				+= -I$(ITFDIR)/../kernel/porting/bsp_armcortexm_sam4eek/itf/component #lowpower
INCLUDE_MCU_CORE				+= -I$(ITFDIR)/../kernel/porting/bsp_armcortexm_sam4eek/itf #lowpower

INCLUDE_MCU_CORE				+= -I$(ITFDIR)/../kernel/porting/bsp_armcortexm_sam4eek/src/board #lowpower
...
CSRCS_default                  += lib_lowpower.c
CSRCS_default                  += lib_ubi_power_manager.c
