 ...
 *
 * $Id: at86rf231.h,v 1.3 2010-08-04 16:05:44 slb Exp $
 *
...
typedef enum trx_cmd_tag
{
    ...
    CMD_TX_ARET_ON                  = (25)
} __attribute__((packed, aligned(4))) trx_cmd_t;
...
} __attribute__((packed, aligned(4))) trx_irq_reason_t;
...
} __attribute__((packed, aligned(4))) tal_trx_status_t;
...
typedef enum trx_trac_status_tag
{
    ...
    TRAC_NO_ACK = 5,
    TRAC_INVALID = 7
} __attribute__((packed, aligned(4))) trx_trac_status_t;
