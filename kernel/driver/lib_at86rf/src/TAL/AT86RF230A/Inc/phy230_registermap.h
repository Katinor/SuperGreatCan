 ...
 */
/**
 * @file phy230_registermap.h
 * generated register definition file
 * Inputfile:  phy230_registermap_external.xml
 * Version:    1.9    for external use
 * Created at: Fri Jun 22 09:55:00 2007
 *
 * $Id: phy230_registermap.h,v 1.1 2010-08-04 16:04:19 slb Exp $
 *
 ...
 * @ingroup apiHalPHY230Const
 * Note: FORCE_PLL_ON is implemented using the software and should not be
 * set onto the transceiver.
 */
#  define CMD_FORCE_PLL_ON         (10)
...
/**
 * Access parameters for sub-register IRQ_7_BAT_LOW in
 * register @ref RG_IRQ_STATUS
 * @ingroup apiHalPHY230Sreg
 */
# define SR_IRQ_7_BAT_LOW             0x0f, 0x80, 7

/**
 * Access parameters for sub-register IRQ_6_TRX_UR in register
 * @ref RG_IRQ_STATUS
 * @ingroup apiHalPHY230Sreg
 */
...
/**
 * Access parameters for sub-register IRQ_3_TRX_END in register
 * @ref RG_IRQ_STATUS
 * @ingroup apiHalPHY230Sreg
 */
...
/**
 * Access parameters for sub-register IRQ_2_RX_START in register
 * @ref RG_IRQ_STATUS
 * @ingroup apiHalPHY230Sreg
 */
...
/**
 * Access parameters for sub-register IRQ_0_PLL_LOCK in register
 * @ref RG_IRQ_STATUS
 * @ingroup apiHalPHY230Sreg
 */
