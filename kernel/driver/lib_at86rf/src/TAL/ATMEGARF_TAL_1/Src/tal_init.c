 ...
 *
 * $Id: tal_init.c,v 1.3 2010-08-01 16:43:15 slb Exp $
 *
...
retval_t tal_init(void)
{
     ...
     */
    pal_trx_irq_init(RFA1_RX_END_IRQ_HDLR_IDX, (FUNC_PTR)trx_rx_end_handler_cb);
    pal_trx_irq_init(RFA1_TX_END_IRQ_HDLR_IDX, (FUNC_PTR)trx_tx_end_handler_cb);

    /* Configure time stamp interrupt. */
    pal_trx_irq_init(RFA1_RX_START_IRQ_HDLR_IDX, (FUNC_PTR)trx_irq_timestamp_handler_cb);
...
#endif
#if ((defined ENABLE_TFA) && (defined TEST_HARNESS))
    {
...
retval_t tal_reset(bool set_default_pib)
{
     ...
     * uninstalled.
     */
    pal_trx_irq_flag_clr(RFA1_RX_END_IRQ_HDLR_IDX);
    pal_trx_irq_flag_clr(RFA1_TX_END_IRQ_HDLR_IDX);
    pal_trx_irq_flag_clr(RFA1_RX_START_IRQ_HDLR_IDX);
...
static void generate_rand_seed(void)
{
     ...
     */
    pal_trx_irq_disable(RFA1_RX_END_IRQ_HDLR_IDX);
    pal_trx_irq_disable(RFA1_TX_END_IRQ_HDLR_IDX);
    ...
    pal_trx_irq_flag_clr(RFA1_RX_END_IRQ_HDLR_IDX);
    pal_trx_irq_flag_clr(RFA1_TX_END_IRQ_HDLR_IDX);
    pal_trx_irq_enable(RFA1_RX_END_IRQ_HDLR_IDX);
    pal_trx_irq_enable(RFA1_TX_END_IRQ_HDLR_IDX);
