 ...
 *
 * $Id: tal_rx.c,v 1.6 2010-08-20 07:35:20 challenger38 Exp $
 *
...
void handle_received_frame_irq(void)
{
    ...
    ((rx_frame_info_t*)store_info_ptr)->timestamp = timestamp_us;
    ...
    {
        /* Set transceiver immediately to PLL_ON. */
