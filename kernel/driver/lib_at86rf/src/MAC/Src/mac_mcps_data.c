 ...
 *
 * $Id: mac_mcps_data.c,v 1.3 2012-02-13 01:31:11 essusige Exp $
 *
...
#include "../Inc/mac_msg_const.h"
#include "../Inc/mac_api.h"
#include "../Inc/mac_msg_types.h"
#include "../Inc/mac_data_structures.h"
#if (MAC_INDIRECT_DATA_FFD == 1)
#include "../../Include/indirect_data_structures.h"
#endif  /* (MAC_INDIRECT_DATA_FFD == 1) */
#if (MAC_START_REQUEST_CONFIRM == 1)
#ifdef BEACON_SUPPORT
#include "../../Include/broadcast_structures.h"
#endif  /* BEACON_SUPPORT */
#endif /* (MAC_START_REQUEST_CONFIRM == 1) */
#include "../../Include/stack_config.h"
#include "../Inc/mac_internal.h"
#include "../Inc/mac.h"
...
void mac_process_data_frame(buffer_t *data_ind)
{
    ...
    else
    {
        ...
        else
        {
             ...
             * information is not present, the values are cleared to prevent
        ...
        else
        {
            ...
            else
            {
                 ...
                 * address information is not present, the values are cleared to
