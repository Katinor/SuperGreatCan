...
#if (MEGA_RF == PAL_GENERIC_TYPE) && (ATMEGA128RFA1 == PAL_TYPE) && (RCB_6_3_BREAKOUT_BOARD == BOARD_TYPE)
...
#endif /* (MEGA_RF == PAL_GENERIC_TYPE) && (ATMEGA128RFA1 == PAL_TYPE) && (RCB_6_3_BREAKOUT_BOARD == BOARD_TYPE) */
