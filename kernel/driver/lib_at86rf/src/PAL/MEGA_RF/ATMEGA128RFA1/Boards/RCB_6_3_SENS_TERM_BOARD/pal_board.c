 ...
 *
 * $Id: pal_board.c,v 1.4 2010-08-05 02:17:38 slb Exp $
 *
...
#if (MEGA_RF == PAL_GENERIC_TYPE) && (ATMEGA128RFA1 == PAL_TYPE) && (RCB_6_3_SENS_TERM_BOARD == BOARD_TYPE)
...
#endif /* (MEGA_RF == PAL_GENERIC_TYPE) && (ATMEGA128RFA1 == PAL_TYPE) && (RCB_6_3_SENS_TERM_BOARD == BOARD_TYPE) */
