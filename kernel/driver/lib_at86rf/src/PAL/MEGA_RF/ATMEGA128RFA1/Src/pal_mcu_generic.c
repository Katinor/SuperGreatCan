 ...
 *
 * $Id: pal_mcu_generic.c,v 1.2 2010-08-01 09:07:37 slb Exp $
 *
...
#if (MEGA_RF == PAL_GENERIC_TYPE) && (ATMEGA128RFA1 == PAL_TYPE)
...
#endif /* (MEGA_RF == PAL_GENERIC_TYPE) && (ATMEGA128RFA1 == PAL_TYPE) */
