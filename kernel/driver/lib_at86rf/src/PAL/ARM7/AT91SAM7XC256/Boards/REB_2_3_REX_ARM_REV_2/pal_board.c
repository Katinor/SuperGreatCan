 ...
 *
 * $Id: pal_board.c,v 1.7 2010-08-05 05:41:48 slb Exp $
 *
 *  @author
...
#if (ARM7 == PAL_GENERIC_TYPE) && (AT91SAM7XC256 == PAL_TYPE) && (REB_2_3_REX_ARM_REV_2 == BOARD_TYPE)
 ...
 */
static unsigned char adc_is_channel_irq_status_set(unsigned int adc_sr, uint8_t channel)
{
...
#endif /* (ARM7 == PAL_GENERIC_TYPE) && (AT91SAM7XC256 == PAL_TYPE) && (REB_2_3_REX_ARM_REV_2 == BOARD_TYPE) */
