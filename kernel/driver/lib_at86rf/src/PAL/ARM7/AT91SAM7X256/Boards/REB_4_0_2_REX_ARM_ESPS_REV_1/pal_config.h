 ...
 *
 * $Id: pal_config.h,v 1.1 2010-08-20 07:31:28 challenger38 Exp $
 *
 */
/**
 * @author
...
#if (BOARD_TYPE == REB_4_0_2_REX_ARM_ESPS_REV_1)
...
#define ENABLE_TRX_IRQ(trx_irq_num)     do {            \
    ...
    {                                                   \
        AT91C_BASE_AIC->AIC_IECR = _BV(AT91C_ID_IRQ0);  \
    }                                                   \
} while (0)
...
#define DISABLE_TRX_IRQ(trx_irq_num)    do {            \
    if (TRX_MAIN_IRQ_HDLR_IDX == trx_irq_num)           \
    {                                                   \
        AT91C_BASE_AIC->AIC_IDCR = _BV(AT91C_ID_IRQ0);  \
    }                                                   \
} while (0)
...
/* RESET pin is pin 9 of PIOA. */
#define RST                             (AT91C_PIO_PA6)

/* Sleep Transceiver pin is pin 8 of PIOA. */
#define SLP_TR                          (AT91C_PIO_PA7)

/*
 * Slave select pin is PA15
 */
#define SEL                             (AT91C_PA12_SPI0_NPCS0)
