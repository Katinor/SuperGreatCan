 ...
 *
 * $Id: pal_board.c,v 1.6 2010-08-05 05:41:48 slb Exp $
 *
 *  @author
...
#if (ARM7 == PAL_GENERIC_TYPE) && (AT91SAM7X256 == PAL_TYPE) && (REB_4_0_2_REX_ARM_REV_3 == BOARD_TYPE)
...
#endif /* (ARM7 == PAL_GENERIC_TYPE) && (AT91SAM7X256 == PAL_TYPE) && (REB_4_0_2_REX_ARM_REV_3 == BOARD_TYPE) */
