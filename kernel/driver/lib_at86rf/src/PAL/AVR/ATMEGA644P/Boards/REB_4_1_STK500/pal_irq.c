 ...
 *
 * $Id: pal_irq.c,v 1.2 2010-08-01 12:05:40 slb Exp $
 *
...
#if (AVR == PAL_GENERIC_TYPE) && (ATMEGA644P == PAL_TYPE) && (REB_4_1_STK500 == BOARD_TYPE)
...
#endif /* (AVR == PAL_GENERIC_TYPE) && (ATMEGA644P == PAL_TYPE) && (REB_4_1_STK500 == BOARD_TYPE) */
