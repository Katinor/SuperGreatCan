 ...
 *
 * $Id: pal_irq.c,v 1.2 2010-08-01 12:03:15 slb Exp $
 *
...
#if (AVR == PAL_GENERIC_TYPE) && (ATMEGA2561 == PAL_TYPE) && (REB_2_3_STK500_STK501 == BOARD_TYPE)
...
#endif /* (AVR == PAL_GENERIC_TYPE) && (ATMEGA2561 == PAL_TYPE) && (REB_2_3_STK500_STK501 == BOARD_TYPE) */
