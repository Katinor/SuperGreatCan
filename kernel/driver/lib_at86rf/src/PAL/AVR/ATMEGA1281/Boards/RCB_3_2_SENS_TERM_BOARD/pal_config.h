 ...
 *
 * $Id: pal_config.h,v 1.2 2010-08-01 11:56:16 slb Exp $
 *
 ...
 *
 * The AT86RF230 provides only one transceiver interrupt (see @ref NO_OF_TRX_IRQS).
