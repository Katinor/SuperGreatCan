 ...
 *
 * $Id: pal_irq.c,v 1.2 2010-08-01 11:59:10 slb Exp $
 *
...
#if (AVR == PAL_GENERIC_TYPE) && (ATMEGA1281 == PAL_TYPE) && (RCB_5_3_SENS_TERM_BOARD == BOARD_TYPE)
...
#endif /* (AVR == PAL_GENERIC_TYPE) && (ATMEGA1281 == PAL_TYPE) && (RCB_5_3_SENS_TERM_BOARD == BOARD_TYPE) */
