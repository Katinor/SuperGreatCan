 ...
 *
 * $Id: pal_irq.c,v 1.2 2010-08-01 11:55:12 slb Exp $
 *
...
#if (AVR == PAL_GENERIC_TYPE) && (ATMEGA1281 == PAL_TYPE) && (RCB_3_2_BREAKOUT_BOARD == BOARD_TYPE)
...
#endif /* (AVR == PAL_GENERIC_TYPE) && (ATMEGA1281 == PAL_TYPE) && (RCB_3_2_BREAKOUT_BOARD == BOARD_TYPE) */
