...
#if (AVR == PAL_GENERIC_TYPE) && (ATMEGA1281 == PAL_TYPE) && (RCB_4_1_BREAKOUT_BOARD == BOARD_TYPE)
...
#endif /* (AVR == PAL_GENERIC_TYPE) && (ATMEGA1281 == PAL_TYPE) && (RCB_4_1_BREAKOUT_BOARD == BOARD_TYPE) */
