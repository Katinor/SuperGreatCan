 ...
 *
 * $Id: pal_irq.c,v 1.2 2010-08-01 11:56:16 slb Exp $
 *
...
#if (AVR == PAL_GENERIC_TYPE) && (ATMEGA1281 == PAL_TYPE) && (RCB_3_2_SENS_TERM_BOARD == BOARD_TYPE)
...
#endif /* (AVR == PAL_GENERIC_TYPE) && (ATMEGA1281 == PAL_TYPE) && (RCB_3_2_SENS_TERM_BOARD == BOARD_TYPE) */
