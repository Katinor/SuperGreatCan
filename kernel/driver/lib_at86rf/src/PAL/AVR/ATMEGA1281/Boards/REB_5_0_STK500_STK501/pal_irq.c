...
#if (AVR == PAL_GENERIC_TYPE) && (ATMEGA1281 == PAL_TYPE) && (REB_5_0_STK500_STK501 == BOARD_TYPE)
...
#endif /* (AVR == PAL_GENERIC_TYPE) && (ATMEGA1281 == PAL_TYPE) && (REB_5_0_STK500_STK501 == BOARD_TYPE) */
