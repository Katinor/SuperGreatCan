 ...
 *
 * $Id: pal_board.c,v 1.4 2010-08-05 02:13:13 slb Exp $
 *
...
#if (XMEGA == PAL_GENERIC_TYPE) && (ATXMEGA128A1 == PAL_TYPE) && (REB_4_1_STK600 == BOARD_TYPE)
...
#endif /* (XMEGA == PAL_GENERIC_TYPE) && (ATXMEGA128A1 == PAL_TYPE) && (REB_4_1_STK600 == BOARD_TYPE) */
