 ...
 *
 * $Id: pal_uart.h,v 1.1 2011-02-28 11:32:05 essusige Exp $
 *
...
#define PIN_UART_0_RXD              (AT91C_PB5_RXD0)//AT91C_PA0_RXD0)

/* The pin on which the data is transmitted by UART */
#define PIN_UART_0_TXD              (AT91C_PB4_TXD0)//AT91C_PA1_TXD0)
...
#ifdef UART1
/* The pin on which the data is received by UART */
#define PIN_UART_1_RXD              (AT91C_PB7_RXD1)//AT91C_PA5_RXD1)

/* The pin on which the data is transmitted by UART */
#define PIN_UART_1_TXD              (AT91C_PB6_TXD1)//AT91C_PA6_TXD1)
