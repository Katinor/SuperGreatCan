 ...
 * internal functions.
 *
 * $Id: pal_timer.h,v 1.1 2011-02-28 11:32:05 essusige Exp $
 *
 ...
 * interrupt
 */
#define TIMER_INPUT_CAPTURE_LINE        (AT91C_PA26_TIOA0)//AT91C_PB23_TIOA0)
...
#define USEC_TO_TIMERTICK(usec)			( (unsigned int) (usec) * ((F_CPUM) / 32 ))
