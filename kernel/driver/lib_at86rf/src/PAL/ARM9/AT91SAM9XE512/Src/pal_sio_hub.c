 ...
 *
 * $Id: pal_sio_hub.c,v 1.1 2011-02-28 11:32:05 essusige Exp $
 *
 */
/**
 * @author
...
#if (ARM9 == PAL_GENERIC_TYPE) && (AT91SAM9XE512 == PAL_TYPE)
...
#endif /* (ARM9 == PAL_GENERIC_TYPE) && (AT91SAM9XE512 == PAL_TYPE) */
