...
INCLUDE_MCU_CORE				+= -I$(ITFDIR)/../kernel/porting/lib_sam4e/sam/drivers/spi
INCLUDE_MCU_CORE				+= -I$(ITFDIR)/../kernel/porting/bsp_armcortexm_sam4eek/itf
...
CFLAG_INCLUDE                   = -I$(ITFDIR) $(INCLUDE_BASE) $(INCLUDE_MCU_DRIVER) $(INCLUDE_BOARD_DRIVER)
...
CSRCS_default                  += lib_at86rf.c
CSRCS_default                  += Applications/API_main/Src/at86rf_API_main.c
CSRCS_default                  += TAL/Src/tal_ed_end_cb.c
CSRCS_default                  += TAL/Src/tal_rx_frame_cb.c
CSRCS_default                  += TAL/Src/tal_tx_frame_done_cb.c
CSRCS_default                  += TAL/AT86RF231/Src/tal_ed.c
CSRCS_default                  += TAL/AT86RF231/Src/tal_init.c
CSRCS_default                  += TAL/AT86RF231/Src/tal_irq_handler.c
CSRCS_default                  += TAL/AT86RF231/Src/tal_pib.c
CSRCS_default                  += TAL/AT86RF231/Src/tal_pwr_mgmt.c
CSRCS_default                  += TAL/AT86RF231/Src/tal_rx_enable.c
CSRCS_default                  += TAL/AT86RF231/Src/tal_rx.c
CSRCS_default                  += TAL/AT86RF231/Src/tal_slotted_csma.c
CSRCS_default                  += TAL/AT86RF231/Src/tal_tx.c
CSRCS_default                  += TAL/AT86RF231/Src/tal.c
CSRCS_default                  += PAL/SAM3S/AT91SAM3S/Boards/REB_4_0_2_REX_ARM_SAM3S_REV_1/pal_board.c
CSRCS_default                  += PAL/SAM3S/AT91SAM3S/Boards/REB_4_0_2_REX_ARM_SAM3S_REV_1/pal_irq.c
CSRCS_default                  += PAL/SAM3S/AT91SAM3S/Src/pal_sio_hub.c
CSRCS_default                  += PAL/SAM3S/Generic/Src/pal_timer.c
CSRCS_default                  += PAL/SAM3S/Generic/Src/pal_trx_access.c
CSRCS_default                  += PAL/SAM3S/Generic/Src/pal_uart.c
CSRCS_default                  += PAL/SAM3S/Generic/Src/pal_utils.c
CSRCS_default                  += PAL/SAM3S/Generic/Src/pal.c
CSRCS_default                  += TFA/AT86RF231/Src/tfa.c
CSRCS_default                  += Resources/Buffer_Management/Src/bmm.c
CSRCS_default                  += Resources/Queue_Management/Src/qmm.c
