#ifndef UBICONFIG_H__lib_ubi_pio
#define UBICONFIG_H__lib_ubi_pio
...
#define UBI_COMPONENT__lib_ubi_pio
#define UBI_COMCONFIG__lib_ubi_pio

#endif /* UBICONFIG_H__lib_ubi_pio */
