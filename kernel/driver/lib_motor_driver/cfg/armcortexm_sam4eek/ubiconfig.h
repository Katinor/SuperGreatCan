#ifndef UBICONFIG_H__lib_motor_driver
#define UBICONFIG_H__lib_motor_driver
...
#define UBI_COMPONENT__lib_motor_driver
#define UBI_COMCONFIG__lib_motor_driver

#endif /* UBICONFIG_H__lib_motor_driver */
