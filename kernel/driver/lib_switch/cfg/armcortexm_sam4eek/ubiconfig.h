#ifndef UBICONFIG_H__lib_switch
#define UBICONFIG_H__lib_switch
...
#define UBI_COMPONENT__lib_switch
#define UBI_COMCONFIG__lib_switch

#endif /* UBICONFIG_H__lib_switch */
