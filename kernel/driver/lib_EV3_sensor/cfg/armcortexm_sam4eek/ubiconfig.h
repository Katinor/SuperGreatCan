#ifndef UBICONFIG_H__lib_EV3_sensor
#define UBICONFIG_H__lib_EV3_sensor
...
#define UBI_COMPONENT__lib_EV3_sensor
#define UBI_COMCONFIG__lib_EV3_sensor

#endif /* UBICONFIG_H__lib_EV3_sensor */
