#ifndef UBICONFIG_H__lib_new_estk_api
#define UBICONFIG_H__lib_new_estk_api
...
#define UBI_COMPONENT__lib_new_estk_api
#define UBI_COMCONFIG__lib_new_estk_api

#endif /* UBICONFIG_H__lib_new_estk_api */
