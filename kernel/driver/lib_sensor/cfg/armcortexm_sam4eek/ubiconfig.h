#ifndef UBICONFIG_H__lib_sensor
#define UBICONFIG_H__lib_sensor
...
#define UBI_COMPONENT__lib_sensor
#define UBI_COMCONFIG__lib_sensor

#endif /* UBICONFIG_H__lib_sensor */
