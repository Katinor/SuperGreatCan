...
#include "_bsp.h"
				...
				char 			_socheck_overflow_handler__buf[SOCHECK_OVERFLOW_HANDLER_BUF_SIZE];
				unsigned int	_socheck_overflow_handler__var1;
				unsigned int	_socheck_overflow_handler__var2;
				_task_pt 		_socheck_overflow_handler__task;
	#endif

				void _socheck_overflow_handler__arm(void) {
	#if defined(UBI_COMCONFIG__lib_ubik)
