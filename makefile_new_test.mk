...
all: info $(OUTDIR)
	...
	$(call MAKE_FUNC,$@,kernel/driver/lib_i2c)
	$(call MAKE_FUNC,$@,kernel/driver/lib_sensor)
	$(call MAKE_FUNC,$@,kernel/driver/lib_EV3_sensor)
	$(call MAKE_FUNC,$@,kernel/driver/lib_switch)
	$(call MAKE_FUNC,$@,kernel/driver/lib_motor_driver)
	$(call MAKE_FUNC,$@,kernel/driver/lib_at86rf)
	$(call MAKE_FUNC,$@,kernel/driver/lib_bluetooth)
	$(call MAKE_FUNC,$@,application/project_ubitools/lib_sensorcalib)
	$(call MAKE_FUNC,$@,application/project_ubitools/lib_new)
	$(call MAKE_FUNC,$@,application/project_ubitools/exe_new_test)
config: info $(OUTDIR)
	@echo "\n[$$(pwd) : make "$@"]"
	$(call MAKE_FUNC,$@,interface/itf_ubinos)
	$(call MAKE_FUNC,$@,kernel/common/lib_ubiclib)
