#ifndef UBICONFIG_H__lib_ubik_port_cortexm_
#define UBICONFIG_H__lib_ubik_port_cortexm_
...
#define EXCLUDE_HRTICK							1
#define EXCLUDE_HRTICK_TICKISR_DELAY_CHECK		1

#include "cfg/property_epilogue.h"

#define UBI_COMPONENT__lib_ubik_port_cortexm
#define UBI_COMCONFIG__lib_ubik_port_cortexm

#endif /* UBICONFIG_H__lib_ubik_port_cortexm_ */
